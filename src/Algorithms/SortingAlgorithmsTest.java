...
class SortingAlgorithmsTest {
    ...
    void testQuickSortCase1() {
        int[] inputArray = {5, 12, 3, 19, 7, 1, 8};
        int[] expectedArray = {1, 3, 5, 7, 8, 12, 19};
        SortingAlgorithms.quickSort(inputArray);
        assertArrayEquals(expectedArray, inputArray);
    }
